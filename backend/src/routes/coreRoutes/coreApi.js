...
const kullaniciController = require('@/controllers/coreControllers/kullaniciController');
const yedekController = require('@/controllers/coreControllers/yedekController');
const logController = require('@/controllers/coreControllers/logController');
...
// Kullanıcı Yönetimi
router.route('/kullanici/list').get(catchErrors(kullaniciController.listele));

// Yedek
router.route('/yedek/indir').get(catchErrors(yedekController.yedekAl));

// İşlem Logu
router.route('/log/list').get(catchErrors(logController.listele));
router.route('/kullanici/create').post(catchErrors(kullaniciController.olustur));
router.route('/kullanici/status/:id').patch(catchErrors(kullaniciController.durumGuncelle));
router.route('/kullanici/delete/:id').delete(catchErrors(kullaniciController.sil));
